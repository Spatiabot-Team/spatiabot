...
export class DiscordCdn {
    ...
    static buildAvatar = (userId,avatarHash) => `${process.env.DISCORD_BASE_URL}avatars/${userId}/${avatarHash}.png`;
    static buildCustomEmoji = (emojiId) => `${process.env.DISCORD_BASE_URL}emojis/${emojiId}.png`;
    static buildGuildIcon = (guildId,guildIcon) => `${process.env.DISCORD_BASE_URL}icons/${guildId}/${guildIcon}.png`;
