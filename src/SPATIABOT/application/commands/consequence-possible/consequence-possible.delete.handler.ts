...
import {ConsequencePossibleDeleteCommand} from "../consequence-possible/consequence-possible.delete.command";
import {
    ConsequencePossibleGetByIdHandler
} from "../../queries/consequence-possible/consequence-possible.get-by-id.handler";
import {
    ConsequencePossibleGetByIdQuery
} from "../../queries/consequence-possible/consequence-possible.get-by-id.query";
